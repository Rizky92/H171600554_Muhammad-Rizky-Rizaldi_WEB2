...
<div class="form-group row">
    ...
    {!! Form::select('kategori_pengumuman_id', $kategori_pengumuman, $selected, ['class' => 'form-control col-md-7', 'name' => 'kategori_pengumuman_id', 'value' => old('kategori_pengumuman_id')]) !!}
</div>
