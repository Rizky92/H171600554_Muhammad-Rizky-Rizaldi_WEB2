...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header text-center">{{ __('Show a Headline') }}</div>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <label for="artikel" class="col-md-6 col-form-label text-md-left">{{ $berita->kategori_berita->nama }}</label>
                    </div>

                    <div class="form-group row">
                        <label for="artikel" class="col-md-4 col-form-label text-md-right">Headline</label>
                    ...
                    <div class="form-group row">
                        ...
                        <label for="artikel" class="col-md-6 col-form-label text-md-left">{{ $berita->isi }}</label>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <label for="artikel" class="col-md-6 col-form-label text-md-left">{{ $berita->users->name }}</label>
                    </div>
