            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <label for="artikel" class="col-md-6 col-form-label text-md-left">{{ $kategori_berita->id }}</label>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <label for="artikel" class="col-md-6 col-form-label text-md-left">{{ $kategori_berita->users->name }}</label>
                    </div>

                    <div class="form-group row justify-content-center">
                        <div class="btn-group" role="group">
                            <a class="btn btn-primary" href="{{ route('kategori_berita.edit', $kategori_berita->id) }}">Edit</a>
                            {!! Form::open(['route' => ['kategori_berita.destroy', $kategori_artikel->id], 'method' => 'delete']) !!}
